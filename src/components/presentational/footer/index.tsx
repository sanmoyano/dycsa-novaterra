    ...
    <div className='flex flex-col justify-center w-full bg-gradient-to-t from-[rgba(0,0,0,.5)] to-transparent'>
      <div className='w-1/2 h-full px-3.5 py-8 sm:px-8 md:p-12 xl:p-24'>
        <form action='#' className='mb-6'>
          <div className='mb-6'>
            <label className='block mb-2 text-sm font-medium text-gray-900 dark:text-white' for='email'>Email</label>
          ...
          <div className='mb-6'>
            <label className='block mb-2 text-sm font-medium text-gray-900 dark:text-white' for='subject'>Subject</label>
          ...
          <div className='mb-6'>
            <label className='block mb-2 text-sm font-medium text-gray-900 dark:text-white' for='message'>Mensaje</label>
