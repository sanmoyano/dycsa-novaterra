  ...
  return (
    <Section>
      <VisibleContainer>
        ...
        <div className='h-full w-full lg:w-4/5 pt-10'>
          <div className='aspect-w-16 aspect-h-9'>
            <iframe allowFullScreen allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share' height='315' src='https://my.matterport.com/show/?m=DeYW6gqpnbS' title='YouTube video player' width='560' />
          </div>
        </div>
      </VisibleContainer>
    </Section>
